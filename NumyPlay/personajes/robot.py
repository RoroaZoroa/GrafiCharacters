...
import math
# from actions import state  # Comentado: módulo del proyecto original no disponible aquí

# Stub mínimo para que las funciones de dibujo funcionen sin el estado completo
class _RobotState:
    expression = "neutral"
    blink_timer = 0.0
    reaction_type = None
    reaction_timer = 0.0
    reaction_duration = 1.0
    walking = False
    animation_angle = 0.0
    color_override = None
